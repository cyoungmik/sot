...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	alert("test");
	$("#packagesBtn").on('click', function(){
		alert("search packages button clicked");
		location.href="/packages.do";
	});
	</script>
									...
									<div class="tab-content">
									 ...
									 <div role="tabpanel" class="tab-pane" id="packages">
									 	<div class="row">
											...
											<div class="col-xs-12">
												<input type="button" id="packagesBtn" class="btn btn-primary btn-block" value="Search Packages">
											</div>
										</div>
									 </div>
									</div>
